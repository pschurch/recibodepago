...
describe "payment_policies/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit payment_policy form" do
    render

    # Run the generator again with the --webrat-matchers flag if you want to use webrat matchers
    assert_select "form", :action => payment_policy_path(@payment_policy), :method => "post" do
