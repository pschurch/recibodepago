...
def payagreementinit
  ...
  PaymentAgreement.create!(:name => "Negocia Ejecutivo", :description => "", :state => 1, :payment_flow_id=> 2)
...
def parameterinit
  Parameter.create!(:name => "Descuento maximo Cobranza", :val_int=> -200, :val_dec=> 0, :description => "Valor maximo de descuento para Cobranza", :state => 1, :help=>'Ingrese el monto, negativo, en el campo "Valor entero", sin decimales. Ej: -200.')
  Parameter.create!(:name => "Descuento maximo Supervisor", :val_int=> -1000, :val_dec=>0, :description => "Valor maximo de descuento para Supervisor", :state => 1, :help=>'Ingrese el monto, negativo, en el campo "Valor entero", sin decimales. Ej: -1000.')
